function AboutUs() {
  ...
  return (
    <>
      ...
      <p>
        We are FTC Team 6406, First Tech Coyotes, from Maryland. Our rookie year
        was 2012, and we continue to compete in FTC events in the Potomac
        region.
      </p>
            ...
            <li key={`year-li-${yearIndex}`}>
              ...
              <ul key={`year-ul-${yearIndex}`} className="mb-4">
                {year_awards.map((ele, awardIndex) => {
                  return (
                    <li key={`award-li-${awardIndex}`} className="ml-8">
                      {ele}
                    </li>
                  );
                })}
